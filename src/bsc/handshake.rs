//! BSC P2P Handshake
//!
//! The Binance Smart Chain (BSC) P2P handshake extends the standard Ethereum handshake
//! with an additional UpgradeStatus message exchange.

use crate::bsc::upgrade_status::{UpgradeStatus, UpgradeStatusExtension};
...
impl EthRlpxHandshake for BscHandshake {
    fn handshake<'a>(
        ...
        Box::pin(async move {
            ...
            tokio::time::timeout(timeout_limit, fut)
                .await
