//! BSC Upgrade Status message
//!
//! Implement BSC upgrade message which is required during handshake with other BSC clients.
//! This is a BSC-specific extension to the standard ETH wire protocol.
